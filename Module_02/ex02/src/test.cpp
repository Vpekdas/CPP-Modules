...
void testComparisonOperators(const Fixed &a, const Fixed &b) {
    ...
    std::cout << NGREEN << "Testing comparison operators" << RESET << std::endl;
    std::cout << NPURPLE << "------------------------------------------" << RESET << std::endl;
...
void testArithmeticOperators(const Fixed &a, const Fixed &b) {
    std::cout << NPURPLE << "------------------------------------------" << RESET << std::endl;
    std::cout << NGREEN << "Testing arithmetic operators" << RESET << std::endl;
    std::cout << NPURPLE << "------------------------------------------" << RESET << std::endl;
...
void testIncrementDecrementOperators(Fixed &a) {
    std::cout << NPURPLE << "------------------------------------------" << RESET << std::endl;
    std::cout << NGREEN << "Testing increment and decrement operators" << RESET << std::endl;
    std::cout << NPURPLE << "------------------------------------------" << RESET << std::endl;
...
void testMinMax(const Fixed &a, const Fixed &b) {
    std::cout << NPURPLE << "------------------------------------------" << RESET << std::endl;
    std::cout << NGREEN << "Testing min and max functions." << RESET << std::endl;
    std::cout << NPURPLE << "------------------------------------------" << RESET << std::endl;
