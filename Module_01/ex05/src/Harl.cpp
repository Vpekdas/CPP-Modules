...
void Harl::_debug(void) {
  std::cout << NEON_YELLOW << "🔺 Got every angle covered. 🔺" << RESET
            << std::endl;
}

void Harl::_info(void) {
  std::cout << NEON_ORANGE
            << "🍊 They're not just oranges. They're blood oranges. 🍊" << RESET
            << std::endl;
}

void Harl::_warning(void) {
  std::cout << NEON_WHITE << "🕒 Do I look like a patient man? 🕒" << RESET
            << std::endl;
}
