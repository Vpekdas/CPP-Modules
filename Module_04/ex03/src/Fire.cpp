...
Fire::Fire() : AMateria("fire") {
    std::cout << YELLOW << "🛠️ Default Fire Constructor called 🛠️" << RESET << std::endl;
}
...
Fire::Fire(const Fire &other) : AMateria(other) {
    std::cout << YELLOW << "🖨️ Fire Copy Constructor called 🖨️" << RESET << std::endl;
}
...
Fire &Fire::operator=(const Fire &other) {
    ...
    std::cout << YELLOW << "📞 Fire Copy Assignment Operator called 📞" << RESET << std::endl;
    return *this;
}
