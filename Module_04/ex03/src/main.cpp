...
int main() {
    ...
    std::cout << NPURPLE << "--------------------------------------------------------------"
              << RESET << std::endl;
    std::cout << NGREEN << "🌟 Creating a Materia Source to learn 5 abilities. 🌟" << RESET
              << std::endl;
    std::cout << NPURPLE << "--------------------------------------------------------------"
              << RESET << std::endl;
    ...
    std::cout << NPURPLE << "--------------------------------------------------------------"
              << RESET << std::endl;
    std::cout << NGREEN << "🌟 Creating a Materia Source to learn 4 abilities. 🌟" << RESET
              << std::endl;
    std::cout << NPURPLE << "--------------------------------------------------------------"
              << RESET << std::endl;
    ...
    std::cout << NPURPLE << "--------------------------------------------------------------"
              << RESET << std::endl;
    std::cout << NGREEN
              << "🚨 Attempting to equip the same Materia twice. This should trigger an error. 🚨"
              << RESET << std::endl;
    std::cout << NPURPLE << "--------------------------------------------------------------"
              << RESET << std::endl;
    cloud->equip(tmp);
    ...
    std::cout << NPURPLE << "--------------------------------------------------------------"
              << RESET << std::endl;
    std::cout << NGREEN << "🚨 Attempting to use an invalid index and out-of-bounds slot. 🚨" << RESET
              << std::endl;
    std::cout << NPURPLE << "--------------------------------------------------------------"
              << RESET << std::endl;
    cloud->use(-42, *tifa);
    ...
    std::cout << NPURPLE << "--------------------------------------------------------------"
              << RESET << std::endl;
    std::cout << NGREEN
              << "✨ Trying to use the Materia with a copy and unequipping first materias. ✨"
              << RESET << std::endl;
    std::cout << NPURPLE << "--------------------------------------------------------------"
              << RESET << std::endl;
    ...
    std::cout << NPURPLE << "--------------------------------------------------------------"
              << RESET << std::endl;
    std::cout << NGREEN << "🚨 Attempting to unequip an invalid index and out-of-bounds slot. 🚨"
              << RESET << std::endl;
    std::cout << NPURPLE << "--------------------------------------------------------------"
              << RESET << std::endl;
    cloud->unequip(0);
    ...
    std::cout << NPURPLE << "--------------------------------------------------------------"
              << RESET << std::endl;
    std::cout << NGREEN << "🧱 Taking a Materia from the floor (Not requested in subject). 🧱"
              << RESET << std::endl;
    std::cout << NPURPLE << "--------------------------------------------------------------"
              << RESET << std::endl;
