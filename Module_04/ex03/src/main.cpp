...
int main() {
    ...
    std::cout << NEON_GREEN << "🌟 Creating a Materia Source to learn 5 abilities. 🌟" << RESET << std::endl;
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    ...
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    std::cout << NEON_GREEN << "🌟 Creating a Materia Source to learn 4 abilities. 🌟" << RESET << std::endl;
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    ...
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    std::cout << NEON_GREEN << "🦸 Creating characters: Cloud and Tifa. 🦸" << RESET << std::endl;
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    ICharacter *cloud = new Character("Cloud");
    ICharacter *tifa = new Character("Tifa");

    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    std::cout << NEON_GREEN << "🎒 Creating and equipping all learned Materia. 🎒" << RESET << std::endl;
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;

    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    std::cout << NEON_GREEN << "📚 Learning and using all materias. 📚" << RESET << std::endl;
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    AMateria *tmp;
    ...
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    std::cout << NEON_GREEN << "🚨 Attempting to use an invalid index and out-of-bounds slot. 🚨" << RESET << std::endl;
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    cloud->use(-42, *tifa);
    cloud->use(42, *tifa);
    cloud->use(4, *tifa);
    ...
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    std::cout << NEON_GREEN << "🦸 Creating a copy of cloud. 🦸" << RESET << std::endl;
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    ...
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    std::cout << NEON_GREEN << "🔄 Unequipping the first Materia and trying to use it. 🔄" << RESET << std::endl;
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    cloud->unequip(0);
    cloud->use(0, *tifa);

    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    std::cout << NEON_GREEN << "🚨 Attempting to unequip an invalid index and out-of-bounds slot. 🚨" << RESET
              << std::endl;
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    cloud->unequip(0);
    cloud->unequip(-42);
    ...
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    std::cout << NEON_GREEN << "🧱 Taking a Materia from the floor (Not requested in subject). 🧱" << RESET
              << std::endl;
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    ...
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    std::cout << NEON_GREEN << "🗑️ Releasing all memory. 🗑️" << RESET << std::endl;
    std::cout << NEON_PURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    delete tifa;
    delete cloud;
    delete cloudCopy;
