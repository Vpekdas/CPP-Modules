...
int main() {
    ...
    std::cout << NPURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    std::cout << NGREEN << "🐶🖨️ Creating a dogcopy and setting new idea. 🐶🖨️" << RESET << std::endl;
    std::cout << NPURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    Dog *dogCopy = new Dog("CopyDog");
    dogCopy->setIdea("🆕 New idea for copy dog 🆕");

    std::cout << NPURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    std::cout << NGREEN << "💭🐶🖨️ Display ideas of copied dog. 💭🐶🖨️" << RESET << std::endl;
    std::cout << NPURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    for (int i = 0; i < 20; i++) {
    ...
    std::cout << NPURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    std::cout << NGREEN << "🖨️🐱 Creating a catcopy and setting new idea. 🖨️🐱" << RESET << std::endl;
    std::cout << NPURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    Cat *catCopy = new Cat(*cat);
    catCopy->setIdea("🆕 New idea for copy cat 🆕");

    std::cout << NPURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    std::cout << NGREEN << "💭🐱🖨️ Display ideas of copied cat. 💭🐱🖨️" << RESET << std::endl;
    std::cout << NPURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    for (int i = 0; i < 20; i++) {
    ...
    std::cout << NPURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    std::cout << NGREEN << "🗑️ Releasing all allocated memory. 🗑️" << RESET << std::endl;
    std::cout << NPURPLE << "--------------------------------------------------------------" << RESET << std::endl;
    for (int i = 0; i < 100; i++) {
        delete animals[i];
    }
