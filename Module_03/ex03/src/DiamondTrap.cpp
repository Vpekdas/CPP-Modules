...
DiamondTrap::DiamondTrap(const std::string &name)
  ...
  std::cout << YELLOW << "🛠️ DiamondTrap Constructor called 🛠️" << RESET
            << std::endl;
}

DiamondTrap::~DiamondTrap() {
  std::cout << RED << "🧨 DiamondTrap Destructor called 🧨" << RESET
            << std::endl;
}
...
void DiamondTrap::whoAmI() {
  ...
  std::cout << "👋😊 " << BLUE << "Hello there, my name is " << NEON_BLUE
            << _name << BLUE << " and my ClapTrap name is " << NEON_BLUE
